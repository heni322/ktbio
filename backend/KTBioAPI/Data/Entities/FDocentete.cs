...
public partial class FDocentete
{
    ...
    public virtual FTaxe? DoCodeTaxe1Navigation { get; set; }

    public virtual FTaxe? DoCodeTaxe2Navigation { get; set; }

    public virtual FTaxe? DoCodeTaxe3Navigation { get; set; }
}
