...
public partial class FProtectioncial
{
    ...
    public virtual FProtectioncial? CbProtUserProfilNavigation { get; set; }

    public virtual ICollection<FDepotuser> FDepotusers { get; set; } = new List<FDepotuser>();

    public virtual ICollection<FEprotectioncial> FEprotectioncials { get; set; } = new List<FEprotectioncial>();

    public virtual ICollection<FProtectioncial> InverseCbProtUserProfilNavigation { get; set; } = new List<FProtectioncial>();
}
